...
private:
  ...
  unique_ptr<Selection> trg_PFHJet500;
  unique_ptr<Selection> trg_TrimMass30;
  ...
  std::unique_ptr<Hists> h_afterAll, h_afterTrimMass30removed;
...
bool B2G_TrimMass_Trigger_Studies::process(Event & event) {
  ...
  // make trigger selection usind singleMu
